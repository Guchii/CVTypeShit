          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button variant="outline" size="sm" onClick={addExperience} className="h-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button variant="outline" size="sm" onClick={addEducation} className="h-8">
                  <PlusCircle className="h-4 w-4 mr-2" />
                  Add
                </Button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {userProfile.skills.map((skill, index) => (
                  <div key={index} className="flex text-sm items-center gap-1 px-3 py-1 bg-muted text-background rounded-full">
                    <span>{skill}</span>
                    <Button
                      variant="ghost"
                      size="icon"
